...
<main class="flex-1 overflow-x-hidden">
  ...
  <?php bg_reveal_start(); ?>
  <section class="liquid-glass-section mx-auto grid max-w-6xl gap-10 px-4 py-14 lg:grid-cols-2">
    <div class="relative z-10">
      ...
      <dl class="mt-6 space-y-5">
        ...
        <div class="glass flex items-start gap-4 p-4">
    ...
    <div class="glass relative overflow-hidden p-6 sm:p-8" data-contact>
      ...
      <div class="hidden h-full flex-col items-center justify-center text-center" data-contact-success>
        ...
        <button type="button" data-contact-reset class="liquid-btn mt-6 px-5 py-2 text-sm"><?php echo h(bg_pick(array('zh' => '再填一份', 'en' => 'Submit Another'), $lang)); ?></button>
      </div>
      <!-- 表单态 -->
      <form class="relative space-y-4" data-contact-form
        ...
        <p class="hidden rounded-lg bg-red-500/10 px-3 py-2 text-sm text-red-600" data-contact-error></p>
        <button type="submit" data-contact-submit class="liquid-btn w-full px-6 py-3 text-sm">
