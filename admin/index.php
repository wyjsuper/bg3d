...
<div class="mx-auto max-w-5xl">
  ...
  <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    <?php foreach ($BG_COLLECTIONS as $c): ?>
      ...
      <a href="<?php e(bg_url('/admin/content/' . $c['type'])); ?>" class="glass-card group flex items-center gap-4 p-5 transition-all hover:-translate-y-0.5 hover:border-tech-blue/40 hover:shadow-lg hover:shadow-tech-blue/10">
