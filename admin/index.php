...
<div class="mx-auto max-w-5xl">
  <div class="rounded-2xl border border-[#0c1426]/10 bg-gradient-to-br from-white to-[#eef3fc] p-6 md:p-8">
    <p class="text-sm font-medium uppercase tracking-widest text-tech-blue">DASHBOARD</p>
  ...
  <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    <?php foreach ($BG_COLLECTIONS as $c): ?>
      ...
      <a href="<?php e(bg_url('/admin/content/' . $c['type'])); ?>" class="group flex items-center gap-4 rounded-2xl border border-[#0c1426]/10 bg-white p-5 transition-all hover:-translate-y-0.5 hover:border-tech-blue/40 hover:shadow-lg hover:shadow-tech-blue/10">
        <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-tech-blue/10 text-tech-blue transition-colors group-hover:bg-tech-blue group-hover:text-white"><?php echo bg_admin_icon(bg_admin_type_icon($c['type']), 20); ?></span>
  ...
  <div class="mt-8 rounded-2xl border border-dashed border-[#0c1426]/15 bg-white/60 p-5 text-xs leading-relaxed text-tech-muted">
