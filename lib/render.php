...
function bg_render_footer($lang) {
  ...
  echo '<div class="border-t border-[#0c1426]/10"><div class="mx-auto grid grid-cols-1 items-center gap-8 px-4 py-10 sm:grid-cols-3">';
  echo '<div class="flex items-center justify-center gap-5 sm:justify-start">';
  bg_brand_logo($logo, 'h-[110px] w-auto drop-shadow-[0_4px_24px_rgba(12,142,255,0.22)]');
